...
<html prefix="og: http://ogp.me/ns#">
  ...
  <body onclick="void(0)" class="et_bloom homepage"  onload="_googWcmGet(phoneCallback, '+1 (702) 800-0521')">
    ...
    <main>
      <div class="w-carousel">
        <div id="slider" class="b-carousel owl-carousel ">
          ...
          <div class="item"><img 
            style="height:670px;"
            src="{{asset('images/landingpage/slide1.png')}}" alt="New Location" width="1800" height="700" /></div>
          <div class="item">
            <img class="block" 
              style="height:670px;"
          ...
          <div class="item">
            <img class="block" 
              style="height:600px;"
              src="{{asset('images/landingpage/slide2.jpg')}}" alt="Happy Customers"  />
            <div class="w-caption bottom-left">
              <div class="caption">
                <div class="head">
                  <strong>
          ...
          <div class="item">
            <img 
              style="height:600px;"
              src="{{asset('images/landingpage/slide3.jpg')}}" alt="Celebrities"  />
      ...
      <section class="w-experiences" >
        ...
        <section class="w-section" style="padding-top: 20px;">
          ...
          <div class="top-section-head">
            ...
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard <br> dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book..</p>
          </div>
        </section>
        ...
        <section class="w-promo">
          <div class="container">
            <div class="item">
              <div style="background-image: url('{{asset('images/landingpage/img6.jpg')}}');" class="img-responsive"></div>
              <div class="overlay">
            ...
            <div class="item">
              <div style="background-image: url('{{asset('images/landingpage/img5.jpg')}}');" class="img-responsive"></div>
              <div class="overlay">
                <div class="b-promo-content">
            ...
            <div class="item">
              <div style="background-image: url('{{asset('images/landingpage/img2.jpg')}}');" class="img-responsive"></div>
              <div class="overlay">
                <div class="b-promo-content">
                  <h3 class="title">
            ...
            <div class="item">
              <div style="background-image: url('{{asset('images/landingpage/img3.jpg')}}');" class="img-responsive"></div>
              <div class="overlay">
                <div class="b-promo-content">
        ...
        <section class="w-gallery main">
          <div class="container">
            <div class="b-gallery text-center">
              ...
              <div class="w-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
    ...
    <footer  style="
      ...
      padding:0px;
      ">
      <div class="row" style="background:#ffffffcf;">
